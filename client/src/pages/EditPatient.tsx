...
const EditPatient = () => {
  ...
  useEffect(() => {
    if (patientToEdit) {
        setFormData({
            ...
            gender: patientToEdit.gender || 'Nam',
            job: patientToEdit.job || '',
            jobCode: patientToEdit.jobCode || '',
            ethnicity: patientToEdit.ethnicity || 'Kinh',
            nationality: patientToEdit.nationality || 'Việt Nam',
            addressStreet: patientToEdit.addressStreet || patientToEdit.address || '',
            addressWard: patientToEdit.addressWard || '',
            addressDistrict: patientToEdit.addressDistrict || '',
            addressProvince: patientToEdit.addressProvince || '',
            workplace: patientToEdit.workplace || '',
            subjectType: patientToEdit.subjectType || 'BHYT',
            insuranceExpiry: patientToEdit.insuranceExpiry || '',
            insuranceNumber: patientToEdit.insuranceNumber || '',
            relativeInfo: patientToEdit.relativeInfo || '',
            relativePhone: patientToEdit.relativePhone || ''
        });
    }
  }, [patientToEdit]);
  ...
  if (!patientToEdit) return <div className="p-8 text-center">Bệnh nhân không tồn tại</div>;
    ...
    <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="bg-gray-50 px-8 py-6 border-b border-gray-200">
            <h1 className="text-xl font-bold text-gray-800">Chỉnh Sửa Thông Tin Bệnh Nhân</h1>
            <p className="text-gray-500 text-sm">Mã BN: {id}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="flex justify-end pt-6 border-t border-gray-100">
               <button 
                type="submit"
                className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-bold transition shadow-md flex items-center"
              >
